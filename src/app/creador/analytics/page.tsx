    ...
    return (
        <div className="min-h-screen bg-[#0a0f0c] text-white flex flex-col p-4 selection:bg-emerald-500/30">
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6">
                ...
                <h2 className="text-3xl font-bold mb-4 tracking-tight">Estamos trabajando en Analytics Pro</h2>
                <p className="text-white/50 text-center max-w-lg leading-relaxed mb-10">
                    En esta sección podrás ver un desglose exhaustivo de la retención de usuarios en tus rutas y gráficos de calor de donde miran el mapa, todo con mapas Recharts fluidos integrados con Stripe Connect.
                </p>
            </div>
        </div>
    );
